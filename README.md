...
<details>
<summary><strong>Click to expand full reference for all 61 tools</strong></summary>
...
and Windows. All 61 tools are implemented and tested. CI produces binaries for all
